namespace EcommerceWeb.Server.Services
{
	public class FileUploader : IFileUploader
	{
		...
		//logger va a permitir guardar cualquier evento dentro de mi aplicacion para poder guardarlo como especie de log
        ...
        public async Task<string> UploadFileAsync(string? base64Imagen, string? archivo)
		{
			...
			try
			{
				//el WebRootPath devuelve la ruta abosluta de wwwwroot
